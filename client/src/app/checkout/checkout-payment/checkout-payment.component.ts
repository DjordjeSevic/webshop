...
import { OrderToCreate } from 'src/app/shared/models/address';
...
export class CheckoutPaymentComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    loadStripe('pk_test_51NFDWyBW9Cknp71QHg68ZbHxvKPECuy6wDftVfl5cmlPtBAjuentqDa4LZZpmjosGU3755FvKw4BHtGxsFg1leED00IvYhQxrb').then(stripe => {
      this.stripe = stripe;
